...
player_damage_event_t* PlayerDamageEvent_new(uint16_t tag, uint64_t entity_id, uint64_t source_entity_id, int damage) {
...
player_damage_event_t* ClientPlayerDamageEvent_new(uint64_t entity_id, uint64_t source_entity_id, int damage) {
    return PlayerDamageEvent_new(CLIENT_PLAYER_DAMAGE_EVENT_TAG, entity_id, source_entity_id, damage);
}

player_damage_event_t* ServerPlayerDamageEvent_new(uint64_t entity_id,  uint64_t source_entity_id, int damage) {
    return PlayerDamageEvent_new(SERVER_PLAYER_DAMAGE_EVENT_TAG, entity_id, source_entity_id, damage);
}