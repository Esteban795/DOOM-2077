...
player_kill_event_t* PlayerKillEvent_new(uint16_t tag, uint64_t entity_id, uint64_t source_entity_id, int8_t weapon_id) {
...
player_kill_event_t* ClientPlayerKillEvent_new(uint64_t entity_id, uint64_t source_entity_id, int8_t weapon_id) {
    return PlayerKillEvent_new(CLIENT_PLAYER_KILL_EVENT_TAG, entity_id, source_entity_id, weapon_id);
}

player_kill_event_t* ServerPlayerKillEvent_new(uint64_t entity_id,  uint64_t source_entity_id, int8_t weapon_id) {
    return PlayerKillEvent_new(SERVER_PLAYER_KILL_EVENT_TAG, entity_id, source_entity_id, weapon_id);
}