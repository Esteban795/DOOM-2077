...
lift* create_lift_from_linedef(linedef** linedefs,int len_linedefs,linedef* line, sector* sector, i16 sector_id,enum LiftType type) {
  ...
  switch (type) {
    ...
    case W1_3_F_LNF:
      ...
      l = lift_create(NULL, sector, speed, low_height, sector->floor_height, 3000, sector->floor_height);
      break;
    case SR_0_S_24U:
    case S1_0_S_24U:
      line->is_pushable = true;
    ...
    case S1_3_S_LFHP:
      ...
      l = lift_create(NULL, sector, L_SLOW, low_height, high_height, 3000, sector->floor_height);
      break;
    case WR_3_S_LFHP:
    case W1_3_S_LFHP:
      line->is_collidable = true;
