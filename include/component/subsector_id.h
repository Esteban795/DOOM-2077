...
/*
subsector_id_ct is a component that represents the subsector id of where an entity currently is.
It has only a single field : subsector_id.
It is essential for the rendering of ennemies.
*/
...
inline int subsector_id_set(subsector_id_ct* subsector_id, int subsector_id_value) {
