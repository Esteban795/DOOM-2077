...
It has only a single field : animation, which is an enum defined in
player_animation.h The goal is to able to synchronize the animations through the
network for better results !
*/
...
*/
enum AnimationType animation_set(animation_ct *animation,
                                 enum AnimationType animation_value);
