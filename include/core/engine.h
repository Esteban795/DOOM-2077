...
/// Reset the engine to its initial state, freeing all resources and
/// reinitializing
///
/// It will deallocate all resources and reinitialize the loaded map, player,
/// bsp, segment handler, players, lifts, and doors.
///
/// \remark the game_start will not be destroyed by this function, the caller
