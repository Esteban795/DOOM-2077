...
*
* Freeing the components array is the responsibility of the caller.  
* \warning Do not free the component items.
*/
...
*
* \note This function guarantees that all events will be processed in the order they were queued.  
