...
If you have a column that starts at the top of the sprite and goes down 1/3 of
it, then stops, then re-starts it would be counted as 1 columns in the
patch_header, but it would be 2 columns in the patch_column.
*/
struct Patch {
  int nb_columns;
  char *patchname;
