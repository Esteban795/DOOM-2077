...
//
// This function will free all the memory allocated by the 'server_load_wad' function.
// It will not free any textures, sounds, or sprites (as they SHOULD NOT be loaded).
// But it will free the map data, as 'server_load_wad' ensure that a map is always loaded.
//
// SAFETY: Do not mix this function with 'wad_data_free', especially if you loaded a map
// using 'init_wad_data'.
