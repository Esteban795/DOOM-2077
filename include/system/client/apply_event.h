#ifndef _LIB_DOOM_SYSTEM_CLIENT_APPLY_EVENT_H
#define _LIB_DOOM_SYSTEM_CLIENT_APPLY_EVENT_H
...
*
* \note This system is intented to be used on the client side, and ensure the world and events are consistent.
*/
